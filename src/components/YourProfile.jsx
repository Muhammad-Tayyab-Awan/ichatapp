function YourProfile() {
  const userData = {
    ...
    gender: "male",
    email: "tayyabpasha1918@gmail.com",
  ...
  return (
    <div>
      ...
      <div className="mx-auto w-[80%]">
        ...
        <div className="mt-2">
          <h1 className="text-center text-lg font-medium">Settings</h1>
          <div className="mt-2 flex w-full items-center justify-center gap-2 px-3 text-xs font-medium">
            <button className="cursor-pointer rounded-full bg-green-700 p-1.5 text-white focus-visible:outline-hidden">
              Update
            </button>
